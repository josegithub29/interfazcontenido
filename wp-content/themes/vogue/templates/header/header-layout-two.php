...
<header id="masthead" class="site-header site-header-two <?php echo ( !get_theme_mod( 'vogue-header-search' ) ) ? '' : sanitize_html_class( 'header-no-search' ); ?> <?php echo ( get_theme_mod( 'vogue-header-density' ) == 'vogue-header-density-compact' ) ? sanitize_html_class( 'site-header-compact' ) : ''; ?> <?php echo ( get_theme_mod( 'vogue-remove-header-lines' ) ) ? sanitize_html_class( 'header-no-lines' ) : ''; ?>">
